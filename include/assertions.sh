...
function assertTestsConfigured()
{
    ...
    # REST Web API tests
    rest_tests_config_path="${vagrant_dir}/magento/dev/tests/api-functional/rest.xml"
    ...
    # SOAP Web API tests
    soap_tests_config_path="${vagrant_dir}/magento/dev/tests/api-functional/soap.xml"
